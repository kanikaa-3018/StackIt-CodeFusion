      ...
      <header className="bg-card/95 backdrop-blur-md border-b border-border sticky top-0 z-50 transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <Button onClick={handleAskQuestion} className="font-medium w-full sm:w-auto hidden md:inline-flex md:w-auto">
              Ask Question
            </Button>
            {/* Right side actions */}
                        ...
                        <div className="max-h-96 overflow-y-auto">
                          {notifications.map((notification) => (
                            <button
                              ...
                              className={`w-full px-4 py-3 hover:bg-muted transition-colors cursor-pointer text-left ${notification.unread ? 'bg-primary/5' : ''
                                }`}
                            >
